...
import { RoadParkListService } from './road_park_list.service';
...
@Component({
  selector: 'road-park',
  templateUrl: './road_park_list.component.html',
  styleUrls: ['./road_park_list.component.scss'],
})
export class RoadParkListComponent implements OnInit {
  private columns = [
  ...
  constructor(private _roadParkListService: RoadParkListService, private router: Router,
