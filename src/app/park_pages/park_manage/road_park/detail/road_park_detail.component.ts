...
import { RoadParkDetailService } from './road_park_detail.service';
...
@Component({
  selector: 'road-park-detail',
  templateUrl: './road_park_detail.component.html',
  styleUrls: ['./road_park_detail.component.scss'],
})
export class RoadParkDetailComponent implements OnInit {
  list1: Car[];
  list2: Car[];
  initBaseLayersData: any;

  constructor(private _roadParkDetailService: RoadParkDetailService) {
