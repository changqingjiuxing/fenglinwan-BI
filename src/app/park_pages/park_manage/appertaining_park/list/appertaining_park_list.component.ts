...
import { AppertainingParkListService } from './appertaining_park_list.service';
...
@Component({
  selector: 'appertaining-park',
  templateUrl: './appertaining_park_list.component.html',
  styleUrls: ['./appertaining_park_list.component.scss'],
})
export class AppertainingParkListComponent implements OnInit {
  private columns = [
  ...
  list1: Car[];
  list2: Car[];
  constructor(private _AppertainingParkListService: AppertainingParkListService,
              private router: Router, private _modalService: NgbModal) {
